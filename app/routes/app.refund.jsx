...
// ✅ Part 2: Complete Remix UI (inside app/routes/app.refund.jsx)
import {
...
export default function RefundPage() {
  ...
  const taxAmount = parseFloat(refundMeta?.taxAmount || 0);
            ...
            <Grid>
              <Grid.Cell columnSpan={{ xs: 6, sm: 8 }}>
                <Card>
                  ...
                  {selectedOrder.lineItems.filter(p => !p.refunded).map(item => {
                ...
                {selectedOrder.lineItems.some(p => p.refunded) && (
                    ...
                    {selectedOrder.lineItems.filter(p => p.refunded).map(item => (
                      <Box key={item.id} display="flex" alignItems="center" paddingBlock="200">
                        ...
                        <Box paddingInlineStart="300">
                          ...
                          <Text variant="bodySm">Qty Refunded: {item.quantity}</Text>
                        </Box>
                      </Box>
                    ))}
                  </Card>
