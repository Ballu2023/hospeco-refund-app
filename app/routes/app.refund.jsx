...
export default function RefundPage() {
  ...
  const safeData = {
    ...
    total: data.total || 0,
    page: data.page || 1,
    selectedOrder: data.selectedOrder || null,
  };
                      ...
                      <div key={refundIndex}>
                        ...
                        {refund.refund_shipping_lines?.length > 0 && (
                          <Box paddingBlock="200" paddingBlockEnd={300}>
                            ...
                            <Text>Amount: ${refund.refund_shipping_lines[0].subtotal_amount_set.shop_money.amount}</Text>
                            <Text>Tax: ${refund.order_adjustments?.[0]?.tax_amount_set?.shop_money?.amount || "0.00"}</Text>
                          </Box>
                        )}
                      </div>
                    ))
        ...
        <Layout.Section>
          <Card>
            ...
            <IndexTable
              ...
              itemCount={safeData.orders.length}
            ...
            <Box padding="300" display="flex" justifyContent="center">
              {safeData.orders.length > 0 && (() => {
                const totalPages = Math.ceil(safeData.total / 10);
                const currentPage = safeData.page;
                const windowSize = 3;
